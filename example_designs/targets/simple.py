...
class LiteSoC(SDSoC):
    ...
    def __init__(self, platform, **kwargs):
        ...
        analyzer = LiteScopeAnalyzer([
            # self.sdctrl.source.valid,
            # self.sdctrl.source.data,
            # self.sdctrl.source.ctrl,
            # self.sdctrl.source.last,
            # self.sdctrl.source.ready,
            # self.sdctrl.sink.valid,
            # self.sdctrl.sink.data,
            # self.sdctrl.sink.ctrl,
            # self.sdctrl.sink.last,
            # self.sdctrl.sink.ready,
            ...
            self.sdphy.cmdr.fifo.source.valid,
            self.sdphy.cmdr.fifo.source.ready,
            self.sdphy.cmdr.fifo.source.last,
            self.sdphy.cmdr.fifo.source.data,
            # self.sdphy.datar.sink.valid,
            # self.sdphy.datar.sink.data,
            # self.sdphy.datar.sink.ctrl,
            # self.sdphy.datar.sink.last,
            # self.sdphy.datar.sink.ready,
            # self.sdphy.datar.source.valid,
            # self.sdphy.datar.source.data,
            # self.sdphy.datar.source.ctrl,
            # self.sdphy.datar.source.last,
            # self.sdphy.datar.source.ready,
            # self.sdphy.datar.read,
            # self.sdphy.datar.toread,
            # self.sdphy.datar.cnt,
            # self.sdphy.datar.status,
            # self.sdphy.datar.dtimeout,
            # self.sdphy.datar.enable,
            # self.sdphy.datar.datarfb.sel,
            # self.sdphy.datar.datarfb.data,
            # self.sdphy.datar.datarfb.source.valid,
            # self.sdphy.datar.datarfb.source.data,
            # self.sdphy.datar.datarfb.source.last,
            # self.sdphy.datar.datarfb.source.ready,
